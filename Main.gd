...
func _on_sector_alpha_trigger_body_entered(body: Node3D) -> void:
	...
	print("The mortal sets foot in the sacred sanctuary (Communion #", sanctuary_visit_count, ")...")
	...
	send_event_to_overseer("mortal_enters_sanctuary", {
		...
		"observation": "Communion #" + str(sanctuary_visit_count) + ". The mortal communes with the Creator at the holy altar."
	})
